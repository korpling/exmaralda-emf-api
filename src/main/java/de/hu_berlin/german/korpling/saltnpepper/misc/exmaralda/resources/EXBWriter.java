...
public class EXBWriter 
{
	...
	{
		//TODO: change fileWriter to StringBuffer, at the end of process write data into file
...
//							fileWriter.println("</tli>");
					...
					{//tier
						...
						{//ud-information
							if (	(tier.getUdTierInformations()!= null) &&
									(tier.getUdTierInformations().size()> 0))
							{	
