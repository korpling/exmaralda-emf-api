...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>exmaraldaBasic</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ExmaraldaBasicExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ExmaraldaBasicPackage.eNS_URI, 
			 ExmaraldaBasicPackage.eINSTANCE);
